...
SWE-bench 还有一个精简版 SWE-bench Lite，包含 300 个经过筛选的任务，更容易运行。SWE-bench 是目前对 Agent 最具挑战性的基准测试之一——即使是 Claude Opus 4.7 配合先进工具，在完整版 SWE-bench Verified 上的通过率也只有 87.6%。
...
3. Liu, Y. et al. "AgentBench: Evaluating LLMs as Agents." ICLR 2024. arXiv:2308.03688

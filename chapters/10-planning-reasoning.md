...
plan_chain = plan_prompt | ChatOpenAI(model="claude-sonnet-4-6")
...
execute_chain = execute_prompt | ChatOpenAI(model="claude-sonnet-4-6")
...
replan_chain = replan_prompt | ChatOpenAI(model="claude-sonnet-4-6")
